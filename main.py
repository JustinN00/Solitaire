...
win_text = my_font.render("You are the Master of Solitaire™", True, "white")
new_text = my_font.render("Push Enter to begin anew...", True, "black")
...
new_game_text = my_font.render("Enter: New Game", True, "black")
...
while running:
    ...
    if won:
        ...
        screen.blit(win_text, (win_screen_rect.x + 10, win_screen_rect.centery - 40))
        screen.blit(new_text, (win_screen_rect.x + 40, win_screen_rect.centery + 20))


    screen.blit(esc_text, (1,1))
    screen.blit(arrow_text, (1, 30))
    screen.blit(space_text, (1, 59))
    screen.blit(new_game_text, (1, 88))
